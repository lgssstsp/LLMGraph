...
def get_args():
    ...
    parser.add_argument('--hyper_epoch', type=int, default=3, help='epoch in hyperopt.')
    # parser.add_argument('--hyper_epoch', type=int, default=30, help='epoch in hyperopt.')
    parser.add_argument('--epochs', type=int, default=20, help='epoch in train GNNs.')
    ...
    # parser.add_argument('--NA_OPS', type=str, default="""NA_OPS = {'SAGEConv': lambda in_dim, out_dim: NaAggregator(in_dim, out_dim, 'SAGEConv'),
    # 'GCNConv': lambda in_dim, out_dim: NaAggregator(in_dim, out_dim, 'GCNConv'),
    # """, help='aggregation_operation')

    # parser.add_argument('--NA_PRIMITIVES', type=list, default=['SAGEConv','GCNConv'], help='aggregation_operation')
